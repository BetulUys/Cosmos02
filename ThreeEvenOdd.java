...
public class ThreeEvenOdd {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("3 tane tek sayı içeriyormu? : "+ucTek(array));
        System.out.println("3 tane çift sayı içeriyormu? : "+ucCift(array));

    }


    private static boolean ucTek(int[] array) {
        boolean sonuc = false;
        int sayac=0;
        for (int w:array
             ) {
        ...
        if (sayac==3) sonuc=true;
        return sonuc;
    }

    private static boolean ucCift(int[] array) {
        boolean sonuc = false;
        int sayac=0;
        for (int w:array
        ) {
